"use strict";(()=>{var e={};e.id=996,e.ids=[996],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8678:e=>{e.exports=import("pg")},7666:(e,E,t)=>{t.a(e,async(e,r)=>{try{t.r(E),t.d(E,{originalPathname:()=>c,patchFetch:()=>a,requestAsyncStorage:()=>o,routeModule:()=>n,serverHooks:()=>u,staticGenerationAsyncStorage:()=>N});var A=t(3278),T=t(5002),s=t(4877),R=t(2233),i=e([R]);R=(i.then?(await i)():i)[0];let n=new A.AppRouteRouteModule({definition:{kind:T.x.APP_ROUTE,page:"/api/notifications/route",pathname:"/api/notifications",filename:"route",bundlePath:"app/api/notifications/route"},resolvedPagePath:"P:\\boursedutemps\\app\\api\\notifications\\route.ts",nextConfigOutput:"",userland:R}),{requestAsyncStorage:o,staticGenerationAsyncStorage:N,serverHooks:u}=n,c="/api/notifications/route";function a(){return(0,s.patchFetch)({serverHooks:u,staticGenerationAsyncStorage:N})}r()}catch(e){r(e)}})},2233:(e,E,t)=>{t.a(e,async(e,r)=>{try{t.r(E),t.d(E,{GET:()=>i,POST:()=>a});var A=t(1309),T=t(871),s=t(7097),R=e([T]);async function i(e){let E=(0,s.bE)(e);if(!E)return A.NextResponse.json({error:"Unauthorized"},{status:401});try{let e=(await (0,T.IO)("SELECT * FROM notifications WHERE user_id = $1 ORDER BY created_at DESC",[E])).rows.map(e=>({id:e.id,userId:e.user_id,type:e.type,content:e.content,fromName:e.from_name,isRead:e.is_read,createdAt:e.created_at}));return A.NextResponse.json(e)}catch(e){return console.error("Error fetching notifications:",e),A.NextResponse.json({error:"Internal Server Error"},{status:500})}}async function a(e){try{let E=await e.json(),t=await (0,T.IO)(`INSERT INTO notifications (user_id, type, content, from_name, is_read)
       VALUES ($1, $2, $3, $4, $5) RETURNING id`,[E.userId,E.type,E.content,E.fromName,E.isRead||!1]);return A.NextResponse.json({id:t.rows[0].id})}catch(e){return console.error("Error creating notification:",e),A.NextResponse.json({error:"Internal Server Error"},{status:500})}}T=(R.then?(await R)():R)[0],r()}catch(e){r(e)}})},871:(e,E,t)=>{t.a(e,async(e,r)=>{try{t.d(E,{IO:()=>n});var A=t(8678),T=e([A]);A=(T.then?(await T)():T)[0];let s="postgres://mock:mock@localhost:5432/mock",R=!0;if(process.env.DATABASE_URL)try{new URL(process.env.DATABASE_URL),s=process.env.DATABASE_URL,R=!1,console.log("[DB] DATABASE_URL is set and valid.")}catch(e){console.error("[DB] Invalid DATABASE_URL format. Falling back to mock URL for build/safety.")}else console.warn("========================================================="),console.warn("WARNING: DATABASE_URL environment variable is missing."),console.warn("Using a mock URL for build purposes."),console.warn("=========================================================");let i=new A.default.Pool({connectionString:s,ssl:!s.includes("localhost")&&{rejectUnauthorized:!1},connectionTimeoutMillis:5e3}),a=!1,n=async(e,E)=>{if(R)return console.warn(`[DB] Mock mode active. Returning empty result for query: ${e.substring(0,50)}...`),{rows:[],rowCount:0};if(!i)throw Error("Database pool not initialized");return a||-1!==e.toLowerCase().indexOf("create table")||-1!==e.toLowerCase().indexOf("alter table")||(await o(),a=!0),await i.query(e,E)},o=async()=>{if(i&&!R)try{let e=await i.connect();try{await e.query(`
