"use strict";(()=>{var e={};e.id=84,e.ids=[84],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8678:e=>{e.exports=import("pg")},334:(e,E,t)=>{t.a(e,async(e,A)=>{try{t.r(E),t.d(E,{originalPathname:()=>u,patchFetch:()=>i,requestAsyncStorage:()=>n,routeModule:()=>o,serverHooks:()=>c,staticGenerationAsyncStorage:()=>N});var r=t(3278),T=t(5002),s=t(4877),R=t(9233),a=e([R]);R=(a.then?(await a)():a)[0];let o=new r.AppRouteRouteModule({definition:{kind:T.x.APP_ROUTE,page:"/api/services/route",pathname:"/api/services",filename:"route",bundlePath:"app/api/services/route"},resolvedPagePath:"P:\\boursedutemps\\app\\api\\services\\route.ts",nextConfigOutput:"",userland:R}),{requestAsyncStorage:n,staticGenerationAsyncStorage:N,serverHooks:c}=o,u="/api/services/route";function i(){return(0,s.patchFetch)({serverHooks:c,staticGenerationAsyncStorage:N})}A()}catch(e){A(e)}})},9233:(e,E,t)=>{t.a(e,async(e,A)=>{try{t.r(E),t.d(E,{GET:()=>R,POST:()=>a});var r=t(1309),T=t(871),s=e([T]);async function R(){try{let e=(await (0,T.IO)("SELECT * FROM services ORDER BY created_at DESC")).rows.map(e=>({id:e.id,userId:e.user_id,userName:e.user_name,title:e.title,description:e.description,creditCost:e.credit_cost,category:e.category,status:e.status,acceptedBy:e.accepted_by,acceptedAt:e.accepted_at,createdAt:e.created_at,updatedAt:e.updated_at}));return r.NextResponse.json(e)}catch(e){return console.error("Error fetching services:",e),r.NextResponse.json({error:"Internal Server Error"},{status:500})}}async function a(e){try{let E=await e.json(),t=await (0,T.IO)(`INSERT INTO services (user_id, user_name, title, description, credit_cost, category)
       VALUES ($1, $2, $3, $4, $5, $6) RETURNING id`,[E.userId,E.userName,E.title,E.description,E.creditCost,E.category]);return r.NextResponse.json({id:t.rows[0].id})}catch(e){return console.error("Error creating service:",e),r.NextResponse.json({error:"Internal Server Error"},{status:500})}}T=(s.then?(await s)():s)[0],A()}catch(e){A(e)}})},871:(e,E,t)=>{t.a(e,async(e,A)=>{try{t.d(E,{IO:()=>o});var r=t(8678),T=e([r]);r=(T.then?(await T)():T)[0];let s="postgres://mock:mock@localhost:5432/mock",R=!0;if(process.env.DATABASE_URL)try{new URL(process.env.DATABASE_URL),s=process.env.DATABASE_URL,R=!1,console.log("[DB] DATABASE_URL is set and valid.")}catch(e){console.error("[DB] Invalid DATABASE_URL format. Falling back to mock URL for build/safety.")}else console.warn("========================================================="),console.warn("WARNING: DATABASE_URL environment variable is missing."),console.warn("Using a mock URL for build purposes."),console.warn("=========================================================");let a=new r.default.Pool({connectionString:s,ssl:!s.includes("localhost")&&{rejectUnauthorized:!1},connectionTimeoutMillis:5e3}),i=!1,o=async(e,E)=>{if(R)return console.warn(`[DB] Mock mode active. Returning empty result for query: ${e.substring(0,50)}...`),{rows:[],rowCount:0};if(!a)throw Error("Database pool not initialized");return i||-1!==e.toLowerCase().indexOf("create table")||-1!==e.toLowerCase().indexOf("alter table")||(await n(),i=!0),await a.query(e,E)},n=async()=>{if(a&&!R)try{let e=await a.connect();try{await e.query(`
      ...
      BEGIN 
        ...
        END;
      END $$;
    `),console.log("[DB] Tables initialized successfully")}finally{e.release()}}catch(e){console.error("[DB] Initialization error:",e)}};A()}catch(e){A(e)}})}};var E=require("../../../webpack-runtime.js");E.C(e);var t=e=>E(E.s=e),A=E.X(0,[379,833],()=>t(334));module.exports=A})();