"use strict";(()=>{var e={};e.id=382,e.ids=[382],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8678:e=>{e.exports=import("pg")},4312:(e,E,t)=>{t.a(e,async(e,A)=>{try{t.r(E),t.d(E,{originalPathname:()=>L,patchFetch:()=>i,requestAsyncStorage:()=>n,routeModule:()=>o,serverHooks:()=>u,staticGenerationAsyncStorage:()=>N});var r=t(3278),T=t(5002),s=t(4877),a=t(2502),R=e([a]);a=(R.then?(await R)():R)[0];let o=new r.AppRouteRouteModule({definition:{kind:T.x.APP_ROUTE,page:"/api/testimonials/route",pathname:"/api/testimonials",filename:"route",bundlePath:"app/api/testimonials/route"},resolvedPagePath:"P:\\boursedutemps\\app\\api\\testimonials\\route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:n,staticGenerationAsyncStorage:N,serverHooks:u}=o,L="/api/testimonials/route";function i(){return(0,s.patchFetch)({serverHooks:u,staticGenerationAsyncStorage:N})}A()}catch(e){A(e)}})},2502:(e,E,t)=>{t.a(e,async(e,A)=>{try{t.r(E),t.d(E,{GET:()=>a,POST:()=>R});var r=t(1309),T=t(871),s=e([T]);async function a(){try{let e=(await (0,T.IO)("SELECT * FROM testimonials ORDER BY created_at DESC")).rows.map(e=>({id:e.id,authorId:e.author_id,authorName:e.author_name,authorAvatar:e.author_avatar,title:e.title||"",content:e.content,rating:e.rating,media:e.media,likes:e.likes,votes:e.likes||[],dislikes:e.dislikes,shares:e.shares,reposts:e.reposts,comments:e.comments,createdAt:e.created_at}));return r.NextResponse.json(e)}catch(e){return console.error("Error fetching testimonials:",e),r.NextResponse.json({error:"Internal Server Error"},{status:500})}}async function R(e){try{let E=await e.json(),t=await (0,T.IO)(`INSERT INTO testimonials (author_id, author_name, author_avatar, title, content, rating, media)
       VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING id`,[E.authorId,E.authorName,E.authorAvatar,E.title,E.content,E.rating,JSON.stringify(E.media||[])]);return r.NextResponse.json({id:t.rows[0].id})}catch(e){return console.error("Error creating testimonial:",e),r.NextResponse.json({error:"Internal Server Error"},{status:500})}}T=(s.then?(await s)():s)[0],A()}catch(e){A(e)}})},871:(e,E,t)=>{t.a(e,async(e,A)=>{try{t.d(E,{IO:()=>o});var r=t(8678),T=e([r]);r=(T.then?(await T)():T)[0];let s="postgres://mock:mock@localhost:5432/mock",a=!0;if(process.env.DATABASE_URL)try{new URL(process.env.DATABASE_URL),s=process.env.DATABASE_URL,a=!1,console.log("[DB] DATABASE_URL is set and valid.")}catch(e){console.error("[DB] Invalid DATABASE_URL format. Falling back to mock URL for build/safety.")}else console.warn("========================================================="),console.warn("WARNING: DATABASE_URL environment variable is missing."),console.warn("Using a mock URL for build purposes."),console.warn("=========================================================");let R=new r.default.Pool({connectionString:s,ssl:!s.includes("localhost")&&{rejectUnauthorized:!1},connectionTimeoutMillis:5e3}),i=!1,o=async(e,E)=>{if(a)return console.warn(`[DB] Mock mode active. Returning empty result for query: ${e.substring(0,50)}...`),{rows:[],rowCount:0};if(!R)throw Error("Database pool not initialized");return i||-1!==e.toLowerCase().indexOf("create table")||-1!==e.toLowerCase().indexOf("alter table")||(await n(),i=!0),await R.query(e,E)},n=async()=>{if(R&&!a)try{let e=await R.connect();try{await e.query(`
      ...
      BEGIN 
        ...
        END;
      END $$;
    `),console.log("[DB] Tables initialized successfully")}finally{e.release()}}catch(e){console.error("[DB] Initialization error:",e)}};A()}catch(e){A(e)}})}};var E=require("../../../webpack-runtime.js");E.C(e);var t=e=>E(E.s=e),A=E.X(0,[379,833],()=>t(4312));module.exports=A})();