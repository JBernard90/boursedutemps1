"use strict";(()=>{var e={};e.id=217,e.ids=[217],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},7790:e=>{e.exports=require("assert")},8893:e=>{e.exports=require("buffer")},4770:e=>{e.exports=require("crypto")},2615:e=>{e.exports=require("http")},5240:e=>{e.exports=require("https")},8216:e=>{e.exports=require("net")},9801:e=>{e.exports=require("os")},6162:e=>{e.exports=require("stream")},2452:e=>{e.exports=require("tls")},4175:e=>{e.exports=require("tty")},7360:e=>{e.exports=require("url")},1764:e=>{e.exports=require("util")},8678:e=>{e.exports=import("pg")},732:(e,t,r)=>{r.a(e,async(e,E)=>{try{r.r(t),r.d(t,{originalPathname:()=>N,patchFetch:()=>R,requestAsyncStorage:()=>n,routeModule:()=>o,serverHooks:()=>c,staticGenerationAsyncStorage:()=>u});var s=r(3278),i=r(5002),A=r(4877),a=r(5833),T=e([a]);a=(T.then?(await T)():T)[0];let o=new s.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/messages/route",pathname:"/api/messages",filename:"route",bundlePath:"app/api/messages/route"},resolvedPagePath:"P:\\boursedutemps\\app\\api\\messages\\route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:n,staticGenerationAsyncStorage:u,serverHooks:c}=o,N="/api/messages/route";function R(){return(0,A.patchFetch)({serverHooks:c,staticGenerationAsyncStorage:u})}E()}catch(e){E(e)}})},5833:(e,t,r)=>{r.a(e,async(e,E)=>{try{r.r(t),r.d(t,{GET:()=>R,POST:()=>o});var s=r(1309),i=r(871),A=r(7097),a=r(7066),T=e([i,a]);async function R(e){let t=(0,A.bE)(e);if(!t)return s.NextResponse.json({error:"Unauthorized"},{status:401});try{let e=(await (0,i.IO)("SELECT * FROM messages WHERE sender_id = $1 OR receiver_id = $1 ORDER BY created_at ASC",[t])).rows.map(e=>({id:e.id,senderId:e.sender_id,receiverId:e.receiver_id,content:e.content,timestamp:e.created_at,isRead:e.is_read||!1}));return s.NextResponse.json(e)}catch(e){return console.error("Error fetching messages:",e),s.NextResponse.json({error:"Internal Server Error"},{status:500})}}async function o(e){try{let t=await e.json(),r=await (0,i.IO)(`INSERT INTO messages (sender_id, receiver_id, content)
       VALUES ($1, $2, $3) RETURNING id`,[t.senderId,t.receiverId,t.content]),E=await (0,i.IO)("SELECT first_name, last_name FROM users WHERE uid = $1",[t.senderId]),A=(E?.rowCount??0)>0?`${E.rows[0].first_name} ${E.rows[0].last_name}`:"Un membre";return await (0,a.z)(t.receiverId,{title:`Nouveau message de ${A}`,body:t.content.length>50?t.content.substring(0,47)+"...":t.content,url:"/profile?chat="+t.senderId}),s.NextResponse.json({id:r.rows[0].id})}catch(e){return console.error("Error creating message:",e),s.NextResponse.json({error:"Internal Server Error"},{status:500})}}[i,a]=T.then?(await T)():T,E()}catch(e){E(e)}})},871:(e,t,r)=>{r.a(e,async(e,E)=>{try{r.d(t,{IO:()=>o});var s=r(8678),i=e([s]);s=(i.then?(await i)():i)[0];let A="postgres://mock:mock@localhost:5432/mock",a=!0;if(process.env.DATABASE_URL)try{new URL(process.env.DATABASE_URL),A=process.env.DATABASE_URL,a=!1,console.log("[DB] DATABASE_URL is set and valid.")}catch(e){console.error("[DB] Invalid DATABASE_URL format. Falling back to mock URL for build/safety.")}else console.warn("========================================================="),console.warn("WARNING: DATABASE_URL environment variable is missing."),console.warn("Using a mock URL for build purposes."),console.warn("=========================================================");let T=new s.default.Pool({connectionString:A,ssl:!A.includes("localhost")&&{rejectUnauthorized:!1},connectionTimeoutMillis:5e3}),R=!1,o=async(e,t)=>{if(a)return console.warn(`[DB] Mock mode active. Returning empty result for query: ${e.substring(0,50)}...`),{rows:[],rowCount:0};if(!T)throw Error("Database pool not initialized");return R||-1!==e.toLowerCase().indexOf("create table")||-1!==e.toLowerCase().indexOf("alter table")||(await n(),R=!0),await T.query(e,t)},n=async()=>{if(T&&!a)try{let e=await T.connect();try{await e.query(`
      ...
      BEGIN 
        ...
        END;
      END $$;
    `),console.log("[DB] Tables initialized successfully")}finally{e.release()}}catch(e){console.error("[DB] Initialization error:",e)}};E()}catch(e){E(e)}})},7097:(e,t,r)=>{r.d(t,{bE:()=>a,fT:()=>A});let E=require("jsonwebtoken");var s=r.n(E);let i=process.env.JWT_SECRET||"your-secret-key";function A(e){return s().sign(e,i,{expiresIn:"7d"})}function a(e){let t=e.headers.get("Authorization");if(!t||!t.startsWith("Bearer "))return null;let r=function(e){try{return s().verify(e,i)}catch(e){return null}}(t.split(" ")[1]);return r?.uid||null}},7066:(e,t,r)=>{r.a(e,async(e,E)=>{try{r.d(t,{z:()=>T});var s=r(1417),i=r.n(s),A=r(871),a=e([A]);A=(a.then?(await a)():a)[0];let R=process.env.NEXT_PUBLIC_VAPID_PUBLIC_KEY,o=process.env.VAPID_PRIVATE_KEY,n=process.env.VAPID_EMAIL||"mailto:example@yourdomain.com";async function T(e,t){try{let r=await (0,A.IO)("SELECT subscription FROM push_subscriptions WHERE user_id = $1",[e]);if(0===r.rowCount){console.log(`No push subscription found for user ${e}`);return}let E=r.rows.map(async r=>{let E=r.subscription;try{await i().sendNotification(E,JSON.stringify(t))}catch(t){410===t.statusCode||404===t.statusCode?(console.log(`Removing expired subscription for user ${e}`),await (0,A.IO)("DELETE FROM push_subscriptions WHERE user_id = $1 AND subscription = $2",[e,JSON.stringify(E)])):console.error("Error sending push notification:",t)}});await Promise.all(E)}catch(e){console.error("Error in sendPushNotification:",e)}}R&&o&&i().setVapidDetails(n,R,o),E()}catch(e){E(e)}})}};var t=require("../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),E=t.X(0,[379,833,417],()=>r(732));module.exports=E})();