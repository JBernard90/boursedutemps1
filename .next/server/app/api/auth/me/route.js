"use strict";(()=>{var e={};e.id=788,e.ids=[788],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8678:e=>{e.exports=import("pg")},232:(e,E,t)=>{t.a(e,async(e,A)=>{try{t.r(E),t.d(E,{originalPathname:()=>l,patchFetch:()=>i,requestAsyncStorage:()=>n,routeModule:()=>o,serverHooks:()=>N,staticGenerationAsyncStorage:()=>u});var T=t(3278),r=t(5002),s=t(4877),R=t(4232),a=e([R]);R=(a.then?(await a)():a)[0];let o=new T.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/api/auth/me/route",pathname:"/api/auth/me",filename:"route",bundlePath:"app/api/auth/me/route"},resolvedPagePath:"P:\\boursedutemps\\app\\api\\auth\\me\\route.ts",nextConfigOutput:"",userland:R}),{requestAsyncStorage:n,staticGenerationAsyncStorage:u,serverHooks:N}=o,l="/api/auth/me/route";function i(){return(0,s.patchFetch)({serverHooks:N,staticGenerationAsyncStorage:u})}A()}catch(e){A(e)}})},4232:(e,E,t)=>{t.a(e,async(e,A)=>{try{t.r(E),t.d(E,{GET:()=>a});var T=t(1309),r=t(7097),s=t(871),R=e([s]);async function a(e){let E=(0,r.bE)(e);if(!E)return T.NextResponse.json({error:"Unauthorized"},{status:401});let t=await (0,s.IO)("SELECT * FROM users WHERE uid = $1",[E]);if(0===t.rowCount)return T.NextResponse.json({error:"User not found"},{status:404});let A=t.rows[0],R={id:A.uid,uid:A.uid,firstName:A.first_name,lastName:A.last_name,email:A.email,department:A.department,whatsapp:A.whatsapp,gender:A.gender,country:A.country,bio:A.bio,offeredSkills:A.offered_skills||[],requestedSkills:A.requested_skills||[],availability:A.availability,languages:A.languages||[],credits:A.credits,avatar:A.avatar,coverPhoto:A.cover_photo,role:A.role,status:A.status,createdAt:A.created_at};return T.NextResponse.json(R)}s=(R.then?(await R)():R)[0],A()}catch(e){A(e)}})},871:(e,E,t)=>{t.a(e,async(e,A)=>{try{t.d(E,{IO:()=>o});var T=t(8678),r=e([T]);T=(r.then?(await r)():r)[0];let s="postgres://mock:mock@localhost:5432/mock",R=!0;if(process.env.DATABASE_URL)try{new URL(process.env.DATABASE_URL),s=process.env.DATABASE_URL,R=!1,console.log("[DB] DATABASE_URL is set and valid.")}catch(e){console.error("[DB] Invalid DATABASE_URL format. Falling back to mock URL for build/safety.")}else console.warn("========================================================="),console.warn("WARNING: DATABASE_URL environment variable is missing."),console.warn("Using a mock URL for build purposes."),console.warn("=========================================================");let a=new T.default.Pool({connectionString:s,ssl:!s.includes("localhost")&&{rejectUnauthorized:!1},connectionTimeoutMillis:5e3}),i=!1,o=async(e,E)=>{if(R)return console.warn(`[DB] Mock mode active. Returning empty result for query: ${e.substring(0,50)}...`),{rows:[],rowCount:0};if(!a)throw Error("Database pool not initialized");return i||-1!==e.toLowerCase().indexOf("create table")||-1!==e.toLowerCase().indexOf("alter table")||(await n(),i=!0),await a.query(e,E)},n=async()=>{if(a&&!R)try{let e=await a.connect();try{await e.query(`
      ...
      BEGIN 
        ...
        END;
      END $$;
    `),console.log("[DB] Tables initialized successfully")}finally{e.release()}}catch(e){console.error("[DB] Initialization error:",e)}};A()}catch(e){A(e)}})},7097:(e,E,t)=>{t.d(E,{bE:()=>R,fT:()=>s});let A=require("jsonwebtoken");var T=t.n(A);let r=process.env.JWT_SECRET||"your-secret-key";function s(e){return T().sign(e,r,{expiresIn:"7d"})}function R(e){let E=e.headers.get("Authorization");if(!E||!E.startsWith("Bearer "))return null;let t=function(e){try{return T().verify(e,r)}catch(e){return null}}(E.split(" ")[1]);return t?.uid||null}}};var E=require("../../../../webpack-runtime.js");E.C(e);var t=e=>E(E.s=e),A=E.X(0,[379,833],()=>t(232));module.exports=A})();