"use strict";(()=>{var e={};e.id=569,e.ids=[569],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},7618:e=>{e.exports=import("bcryptjs")},8678:e=>{e.exports=import("pg")},5846:(e,t,E)=>{E.a(e,async(e,r)=>{try{E.r(t),E.d(t,{originalPathname:()=>N,patchFetch:()=>R,requestAsyncStorage:()=>o,routeModule:()=>n,serverHooks:()=>l,staticGenerationAsyncStorage:()=>u});var s=E(3278),A=E(5002),a=E(4877),T=E(7007),i=e([T]);T=(i.then?(await i)():i)[0];let n=new s.AppRouteRouteModule({definition:{kind:A.x.APP_ROUTE,page:"/api/register/route",pathname:"/api/register",filename:"route",bundlePath:"app/api/register/route"},resolvedPagePath:"P:\\boursedutemps\\app\\api\\register\\route.ts",nextConfigOutput:"",userland:T}),{requestAsyncStorage:o,staticGenerationAsyncStorage:u,serverHooks:l}=n,N="/api/register/route";function R(){return(0,a.patchFetch)({serverHooks:l,staticGenerationAsyncStorage:u})}r()}catch(e){r(e)}})},7007:(e,t,E)=>{E.a(e,async(e,r)=>{try{E.r(t),E.d(t,{POST:()=>n});var s=E(1309),A=E(871),a=E(7097),T=E(7618),i=E(1063),R=e([A,T]);async function n(e){let t=await e.json();if(!t.email||!t.password||!t.firstName||!t.lastName)return s.NextResponse.json({error:"Champs requis manquants"},{status:400});if((await (0,A.IO)("SELECT * FROM users WHERE email = $1",[t.email])).rowCount>0)return s.NextResponse.json({error:"Cet email est d\xe9j\xe0 utilis\xe9"},{status:400});let E=await T.default.hash(t.password,10),r=(0,i.Z)(),R="jeanbernardpierrelouis@gmail.com"===t.email?"admin":"user";try{await (0,A.IO)(`INSERT INTO users (
      ...
      BEGIN 
        ...
        END;
      END $$;
    `),console.log("[DB] Tables initialized successfully")}finally{e.release()}}catch(e){console.error("[DB] Initialization error:",e)}};r()}catch(e){r(e)}})},7097:(e,t,E)=>{E.d(t,{bE:()=>T,fT:()=>a});let r=require("jsonwebtoken");var s=E.n(r);let A=process.env.JWT_SECRET||"your-secret-key";function a(e){return s().sign(e,A,{expiresIn:"7d"})}function T(e){let t=e.headers.get("Authorization");if(!t||!t.startsWith("Bearer "))return null;let E=function(e){try{return s().verify(e,A)}catch(e){return null}}(t.split(" ")[1]);return E?.uid||null}},1063:(e,t,E)=>{E.d(t,{Z:()=>i});let r=require("node:crypto"),s={randomUUID:r.randomUUID},A=new Uint8Array(256),a=A.length,T=[];for(let e=0;e<256;++e)T.push((e+256).toString(16).slice(1));let i=function(e,t,E){return!s.randomUUID||t||e?function(e,t,E){let s=(e=e||{}).random??e.rng?.()??(a>A.length-16&&((0,r.randomFillSync)(A),a=0),A.slice(a,a+=16));if(s.length<16)throw Error("Random bytes length must be >= 16");if(s[6]=15&s[6]|64,s[8]=63&s[8]|128,t){if((E=E||0)<0||E+16>t.length)throw RangeError(`UUID byte range ${E}:${E+15} is out of buffer bounds`);for(let e=0;e<16;++e)t[E+e]=s[e];return t}return function(e,t=0){return(T[e[t+0]]+T[e[t+1]]+T[e[t+2]]+T[e[t+3]]+"-"+T[e[t+4]]+T[e[t+5]]+"-"+T[e[t+6]]+T[e[t+7]]+"-"+T[e[t+8]]+T[e[t+9]]+"-"+T[e[t+10]]+T[e[t+11]]+T[e[t+12]]+T[e[t+13]]+T[e[t+14]]+T[e[t+15]]).toLowerCase()}(s)}(e,t,E):s.randomUUID()}}};var t=require("../../../webpack-runtime.js");t.C(e);var E=e=>t(t.s=e),r=t.X(0,[379,833],()=>E(5846));module.exports=r})();